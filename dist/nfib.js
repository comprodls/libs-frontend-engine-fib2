...
define("text", ["module"], function(module) {
        ...
        nfib = function() {
            ...
            function handleQuestionTextOnKeydown(event) {
                ...
                newAnswer !== __content.userAnswersXML[interaction_id] && (__content.userAnswersXML[interaction_id] = newAnswer, saveResults())
            }
            ...
            function setupEventHandlers() {
                $("." + __constants.DOM_SEL_INPUT_BOX).keydown(handleQuestionTextOnKeydown), $(".toggleDiv").on("click", function() {
