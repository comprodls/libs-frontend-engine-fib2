...
define("text", ["module"], function(module) {
        ...
        nfib = function() {
            ...
            function init(elRoot, params, adaptor, htmlLayout, jsonContentObj, callback) {
                var isContentValid = !0,
                    jsonContent = jQuery.extend(!0, {}, jsonContentObj);
            ...
            function parseAndUpdateJSONContent(jsonContent, params) {
                ...
                return __content.directionsXML = jsonContent.content.instructions[0][tagName], jsonContent.content.directions = __content.directionsXML, __content.activityType = params.engineType, parseAndUpdateQuestionDataTypeJSON(jsonContent), jsonContent
            }
            ...
            function saveUpdatedJson() {
                processedJsonContent.content.instructions = $(".edit-instruction-val").val(), processedJsonContent.content.questiondata[0].correctanswer = $(".edit-answer-val").val(), recreateJSON(processedJsonContent)
            }

            function recreateJSON() {
                var updatedJSON = jQuery.extend(!0, {}, originalContent);
                updatedJSON.content.instructions[0].html = processedJsonContent.content.instructions, updatedJSON.content.responses.i1.correct = processedJsonContent.content.questiondata[0].correctanswer
            }
